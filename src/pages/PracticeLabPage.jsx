...
const components = { 'area-calculator': AreaCalculator, 'color-picker': ColorPicker, 'otp-generator': OTPGenerator, 'event-rsvp': EventRSVP, 'mood-board': MoodBoard };
export default function PracticeLabPage() {
  ...
  const title = lang === 'ru' ? lab.titleRu ?? lab.title : lab.title;
  return (
    <section className="practice">
      <PageMeta title={`${title} — Aleksei Lopatin`} description={lab.description[lang]} />
